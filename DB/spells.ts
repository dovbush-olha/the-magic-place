...
const SPELLS_EN: Array<Spell> = [
  ...
  },
  {
    ...
    interesting_fact: "Arthur Weasley uses this spell at the Dursleys' house in 1994.",
  },
  {
    name: 'Expelliarmus',
  ...
  },
  {
    ...
    interesting_fact: 'Draco Malfoy using this spell on Harry Potter at the Duelling Club.',
  },
  {
    name: 'Serpensortia',
    book: 'Harry Potter and the Chamber of Secrets',
  ...
  },
  {
    ...
    interesting_fact: '"Hermione tapped the diary three times and said, "Aparecium!" Nothing happened."',
  },
  {
    name: 'Obliviate',
    book: 'Harry Potter and the Chamber of Secrets',
  ...
  },
  {
    ...
    interesting_fact: 'This noise disrupted all in its path, and could even be used to harm opponents.',
  },
  {
    name: 'Morsmordre',
    book: 'Harry Potter and the Goblet of Fire',
  ...
  },
  {
    ...
    interesting_fact: 'This spell is the reverse of Alohomora.',
  },
  {
    name: 'Episkey',
  ...
  },
  {
    ...
    interesting_fact: 'Latin expulso, meaning "expel".',
  },
  {
    name: 'Stupefy',
    book: 'Harry Potter and the Deathly Hallows',
...
const SPELLS_UKR: Array<Spell> = [
  {
    ...
    interesting_fact:
      'У першій книзі та фільмі "Гаррі Поттер і Філософський Камінь" Герміона Грейнджер виправляє вимову Рона Візлі у заклинанні, демонструючи свою експертизу в чаклунстві та встановлюючи свій образ як кваліфікованої відьми.',
  },
  {
    name: 'Алогомора',
    book: 'Гаррі Поттер і Філософський Камінь',
  ...
  },
  {
    ...
    interesting_fact:
      'Ріктусемпра — це заклинання, яке викликає у цілі відчуття, ніби її лоскочуть. У книзі Гаррі використовує заклинання Драко Мелфоя під час дуелі в коридорі на другому поверсі Гоґвортсу, змусивши Мелфоя впасти від сміху.',
  },
  {
    name: 'Тарантелеґра',
    book: 'Гаррі Поттер і Таємна Кімната',
  ...
  },
  {
    ...
    book: 'Гаррі Поттер і Таємна Кімната',
    description:
      'Це закляття випускає змію з кінчика чарівної палички. При цьому слід враховувати, щочаклун, який не знає парселмови не зможе її цілком контролювати.',
    interesting_fact: 'Використано Мелфоєм у другій книзі під час дуелі проти Гаррі Поттера.',
  },
  {
    name: 'Апареціум',
    book: 'Гаррі Поттер і Таємна Кімната',
    description: 'Це закляття, що виявляє невидиме чорнило й робить його видимим.',
    interesting_fact: '“Герміона тричі вдарила щоденник паличкою і вимовила: — Апареціум!”',
  },
  {
    name: 'Забуттятус',
    book: 'Гаррі Поттер і Таємна Кімната',
  ...
  },
  {
    ...
    book: 'Гаррі Поттер і Таємна Кімната',
    description:
      'Створює вузький промінь світла на кінчику палички. Його окрасою є те, що його можна поєднувати разом з іншими закляттями. Тобто лумос робить паличку своєрідним ліхтариком.',
    interesting_fact:
      'У фільмах ефект Лумоса був досягнутий тим, що актор натискав кінчиком своєї палички спеціальну чутливу до світла подушку, яка активувала світло всередині реквізиту палички.',
  },

  {
    name: 'Нокс',
    book: "Гаррі Поттер і В'язень Азкабану",
    description: 'Ці чари гасять світло з палички, і є протилежним до закляття Лумос.',
    interesting_fact:
  ...
  },
  {
    ...
    book: "Гаррі Поттер і В'язень Азкабану",
    description:
      'Заклинання, яке використовується ховчиків. Воно змушує перетворюватися їх на смішну форму того, про що думає чарівник і тим самим відбирає в ховчика головну зброю – страх.',
    interesting_fact:
  ...
  },
  {
    ...
    book: "Гаррі Поттер і В'язень Азкабану",
    description:
      'Використовується для огорожі від зовнішньої фізичної дії води, повітря, будь-яких інших речовин і предметів.',
    interesting_fact:
...

  {
    ...
    interesting_fact:
      'У фільмах звуковий ефект для заклинання Акціо був створений за допомогою запису високочастотного звуку келиха, натираючи його вологим пальцем.',
  },
  {
    name: 'Сонорус',
    book: 'Гаррі Поттер і Келих Вогню',
    description: 'Збільшує гучність голосу чаклуна.',
    interesting_fact: 'Це закляття можна використовувати для спілкування на великій відстані або в шумному середовищі.',
  },
  {
    name: 'Морсмордре',
    book: 'Гаррі Поттер і Келих Вогню',
  ...
  },
  {
    ...
    interesting_fact:
      'Ефект зворотного заклинання, також відомий як Priori Incantatem, був особливо рідкісним проявом цього заклинання, яке відбувалося, коли дві палички з однаковим стрижнем (тобто взяті з тієї самої тварини) намагалися битися одна з одною.',
  },
  {
    name: 'Репаро',
    book: 'Гаррі Поттер і Келих Вогню',
    ...
    interesting_fact:
      "Закляття може відновити лише ті об'єкти, які фізично пошкоджені або зламані. Воно не може створювати нові об'єкти або відновлювати об'єкти, що втратили деякі частини. Крім того, ефективність заклинання залежить від майстерності і здібностей заклинача.",
  },
  {
    name: 'Денсоґіо',
    book: 'Гаррі Поттер і Келих Вогню',
    ...
    interesting_fact:
      'Герміона Ґрейнджер була вражена цією чарівною паличкою Драко Мелфоя. Драко та Гаррі Поттер почали битися в коридорі, що зрештою призвело до дуелі, але заклинання, які вони наклали один на одного, не влучили й натомість вразили Герміону та Грегорі Ґойла.',
  },
  {
    name: 'Авада Кедавра',
    book: 'Гаррі Поттер і Келих Вогню',
    ...
    interesting_fact:
      "Назва закляття походить від арамейської фрази 'abracadabra', що перекладається як 'хай це знищиться'. Деякі фанати серії пов'язують цю назву з фразою 'авада кедавра' у сенсі 'я руйную', яка може посилатись на збройні конфлікти та війни.",
  },
  {
    name: 'Круціо',
    book: 'Гаррі Поттер і Келих Вогню',
  ...
  },
  {
    ...
    interesting_fact:
      'Це було одне із заклинань, яким Гаррі Поттер навчив армію Дамблдора, який раніше використовував це заклинання під час Турніру трьох чаклунів.',
  },

  {
    ...
    interesting_fact:
      'Досвідчені заклинальники також могли переміщати більше ніж один предмет за раз і використовувати його для таких тривіальних завдань, як сервірування столу для їжі одним махом.',
  },
  {
    name: 'Еванеско',
    book: 'Гаррі Поттер і Орден Фенікса',
    ...
    interesting_fact:
      'Зі складністю тварини стало важче зникнути; наприклад, равлик, як безхребетна тварина, був досить простий, тоді як миша, як ссавець, представляла великий виклик.',
  },
  {
    name: 'Леґіліменс',
    book: 'Гаррі Поттер і Орден Фенікса',
    description:
      'Це чари, які дозволяли заклинателю виконати Легіліменцію; іншими словами, заглибитися в розум жертви, дозволяючи заклинателю побачити спогади, емоції та думки.',
    interesting_fact:
  ...
  },
  {
    ...
    book: 'Гаррі Поттер і Орден Фенікса',
    description:
      'Заклинання, яке використовують для створення магічного щита, який захищає заклинаючого від заклять та фізичних атак.',
    interesting_fact:
      'Це заклинання використовувала Герміона, щоб захистити себе та Гаррі від атак Смертжерів під час їхнього пошуку Хоркруксів.',
  },
  {
    name: 'Колопортус',
    book: 'Гаррі Поттер і Орден Фенікса',
    description: 'Магічно закриває двері, є протилежним до Алогомори.',
    interesting_fact: 'Запечатані Колопортусом двері не можна відкрити Алогоморою — їх можна тільки зруйнувати.',
  },

  {
    ...
    interesting_fact:
      "Це заклинання було використано Тонкс, щоб вилікувати зламаний ніс Гаррі Поттреа в 'Гаррі Поттері та напівкровний принц'.",
  },
  {
    name: 'Левікорпус',
    book: 'Гаррі Поттер і Напівкровний Принц',
  ...
  },
  {
    name: 'Глушилято',
    book: 'Гаррі Поттер і Напівкровний Принц',
    description: 'Наповнює вуха невідомим шумом, через що люди не можуть чути розмови, які ведуться поряд.',
    interesting_fact:
      'А ви знали, що це замовляння винайшов Северус Снейп? У книжці «Гаррі Поттер і Напівкровний Принц» Гаррі застосував його проти лікарки, аби вона не чула, про що він говорив з ельфами-домовиками.',
  },
  {
    name: 'Сектумсемпра',
    book: 'Гаррі Поттер і Напівкровний Принц',
...

  {
    ...
    interesting_fact:
      '“– Експульсо! – заревів смертежер, і стіл, за яким стояв Гаррі, розлетівся на друзки.\n' +
      'Вибуховою хвилею його жбурнуло об стіну”',
  },
  {
    name: 'Заклятус',
    book: 'Гаррі Поттер і Смертельні Реклівії',
  ...
  },
  {
    ...
    interesting_fact:
      'Це заклинання використала Герміона, створивши точну копію медальйона, який вони вкрали у Долорес Амбридж, і передала копію інквізитору, щоб вона не запідозрила, що медальйон зник у неї.',
  },
];
