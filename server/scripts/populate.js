...
mongoose.connect("mongodb+srv://root:5D1iQ69yAT74gtZU@cluster0.8rziwnr.mongodb.net/magic-place", { useNewUrlParser: true, useUnifiedTopology: true, serverApi: ServerApiVersion.v1 })
...
const SPELLS_UKR = [
  ...
  },
  {
    ...
    interestingFact:
      'Сектумсемпра була створена Северусом Снейпом, коли він був учнем у Гоґвартсі, та була використана Гаррі Поттером під час дуелі з Драко Малфоєм.',
  },
  {
    name: 'Аґваменті',
    book: 'Гаррі Поттер і Напівкровний Принц',
