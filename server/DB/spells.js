...
const SPELLS_UKR = [
  ...
  },
  {
    ...
    interesting_fact: 'Це було одне із заклинань, що Гаррі Поттер навчив членів Армії Дамблдора.',
  },
...

  {
    ...
    interesting_fact: 'Це заклинання було використано Тонкс, щоб вправити зламаний ніс Гаррі Поттера.',
  },
  {
    name: 'Левікорпус',
    book: 'Гаррі Поттер і Напівкровний Принц',
...
(async () => {
    try {
        await sequelize.transaction(async t => {
            for (let i = 0; i < SPELLS_EN.length; i++) {
                await Spell.create({
                    UK: SPELLS_EN[i],
                    EN: SPELLS_UKR[i],
                }, { transaction: t });
