...
const OTHER_UA: Array<Character> = [
  ...
  },
  {
    name: 'Арґуч Філч',
    portrait: '',
    description: 'Сквиб та доглядач Гоґвартсу, школи магії і чаклунства, з приблизно 1973 року.',
    interestingFact:
  ...
  },
  {
    ...
    portrait: '',
    description: 'Британська або ірландська відьма та медсестра у Гоґвартській школі магії і чаклунства.',
    interestingFact:
  ...
  },
  {
    ...
    interestingFact:
      'Його дружина померла, коли їхній дитині було дев\'ять років, і він самотужки виховував дочку. Він вірив в існування Смертельних Реліквій і підтримував Гаррі в газеті "Базікалло", коли мало хто інший це робив.',
  },
  {
